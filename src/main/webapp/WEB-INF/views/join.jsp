			...
			<div class="insert">
				...
				<table>
					<tr>
						...
						<a  id="btn-id" class='btn-fill-s'>중복 확인</a>
					...
					<tr>
						...
						<input class='but2' type="button" value="인증번호 발송" onclick="">
						</td>
					</tr>
					...
					<tr id="cr_email">
						...
						<td class="col2">
						<input type="text" name="emailCheck" maxlength="16"> 
						<input class='but2' type="button" value="확인" onclick="">
						</td>
					</tr>
					...
					<tr>
						...
						<input class='but1' type="button" value="중복 확인" onclick=""></td>
					</tr>
					...
					<tr>
						<td class="col1">키</td>
						<td class="col2">
						<input type="number" id="users_height" name="users_height">
						</td>
					</tr>
					...
					<tr>
						...
						<td class="col2">
						<input type="number" id="users_weight" name="users_weight"></td>
					</tr>
				...
				<div class="form-group" style="text-align: center">
					...
					<div data-toggle="buttons">
						<input id="agree" type="checkbox" autocomplete="off"> <a>이용약관에 동의합니다.</a>
					</div>
